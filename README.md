...
- [Slides React](https://docs.google.com/presentation/d/1xQt28PbPo7itoSh5h22ESFMJYYdZ8_E6WFVz0ijLkWk/edit?usp=sharing)

- [Dernière version de React](https://reactjs.org/versions/)

- [Démarrer une application react](https://github.com/facebook/create-react-app#creating-an-app)

- [Documentation React](https://fr.reactjs.org/docs/getting-started.html)

- [Documentation ReactRouter](https://reacttraining.com/react-router/web/guides/quick-start)

- [Documentation Styled Components](https://styled-components.com/docs/basics)
